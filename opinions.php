...
<div>
<ol class="opinion">
<li><a class="opinionDiv" href="browse.php">Przeglądanie recenzji</a></li>
<li><a class="opinionDiv" href="insert.php">Dodawanie recenzji</a></li>
<li><a class="opinionDiv" href="update.php">Edycja recenzji</a></li>
<li><a class="opinionDiv" href="delete.php">Usuwanie recenzji</a></li>
<li><a class="opinionDiv" href="summary.php">Podsumowanie recenzji</a></li>
</ol>
</div>
...
<!-- load link into div on click-->
$(document).ready(function() {
    $('.opinionDiv').click(function(event) {
        event.preventDefault();
