...
error_reporting(E_ALL ^ E_NOTICE);  
	...
	switch($_GET['el']){
	case "1":
		include 'baza_insert.php';
	break;
	
	case "2":
		include 'baza_przegl.php';
	break;
	
	case "3":
		include 'baza_update.php';
	break;
	
	case "4":
		include 'baza_delete.php';
	break;
	
}
?>
<h2> Recenzje restauracji Lorem Ipsum - menu</h2>

<div class="rec">
<a href="opinions.php?el=1">Dodawanie recenzji</a>
<br>
<a href="opinions.php?el=2">Przeglądanie recenzji</a>
<br>
<a href="opinions.php?el=3">Edytowanie recenzji</a>
<br>
<a href="opinions.php?el=4">Usuwanie recenzji</a>
<br>
